...
document.addEventListener("DOMContentLoaded", () => {
    ...
    // Función para mover el carrusel a una posición dada
    ...
    botonMusica.addEventListener("click", () => {
      if (musica.paused) {
        musica.play();
        botonMusica.textContent = "Pausa"; // Cambia el icono a pausa
      } else {
        musica.pause();
        botonMusica.textContent = "Música"; // Cambia el icono a play
      }
    });
  });
